...
namespace WebListenerWebApp
{
    public class Program
    {
        ...
        {
            ServiceRuntime.RegisterServiceAsync("WebListenerWebAppType", context => new WebHostingService(context, "ServiceEndpoint")).GetAwaiter().GetResult();
